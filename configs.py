config_original = {
        ...
        'pos_pretrain_path': './models/original/ewt_original.pt',
        'depparse_pretrain_path': './models/original/ewt_original.pt',
...
config_fast_text = {
        ...
        'pos_pretrain_path': './models/fast-text/ewt_fast_text.pt',
        'depparse_pretrain_path': './models/fast-text/ewt_fast_text.pt',
...
config_glove = {
        ...
        'pos_pretrain_path': './models/glove/ewt_glove.pt',
        'depparse_pretrain_path': './models/glove/ewt_glove.pt',
