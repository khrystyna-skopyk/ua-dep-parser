...
config_original = {
        ...
        'pos_pretrain_path': f'{ROOT_DIR}/models/original/ewt_original.pt',
        'depparse_pretrain_path': f'{ROOT_DIR}/models/original/ewt_original.pt',
...
config_fast_text = {
        ...
        'pos_pretrain_path': f'{ROOT_DIR}/models/fast-text/ewt_fast_text.pt',
        'depparse_pretrain_path': f'{ROOT_DIR}/models/fast-text/ewt_fast_text.pt',
...
config_glove = {
        ...
        'pos_pretrain_path': f'{ROOT_DIR}/models/glove/ewt_glove.pt',
        'depparse_pretrain_path': f'{ROOT_DIR}/models/glove/ewt_glove.pt',
